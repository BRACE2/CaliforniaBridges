...
%\usepackage{$styledir$/classicthesis}
...
\makeatother
$endif$
\newcommand\elstirSubtitle{$subtitle$}
\subtitle{$subtitle$}
$endif$
\newcommand\elstirAuthor{$for(author)$$author$$sep$ \and $endfor$}
\author{$for(author)$$author$$sep$ \and $endfor$}
\date{$date$}

$if(institute)$
\newcommand\elstirInstitution{$institute$}
$endif$
